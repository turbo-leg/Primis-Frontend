      ...
      <AuthenticatedLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">{t('courseDetails.loading')}</p>
          </div>
        </div>
      </AuthenticatedLayout>
    )
  ...
  if (!course) {
    return (
      <AuthenticatedLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            <p className="text-xl text-gray-600 dark:text-gray-400">{t('courseDetails.notFound')}</p>
          ...
          <Card>
            ...
            <CardContent>
              <dl className="grid grid-cols-2 gap-4">
                <div>
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('courseDetails.overview.startDate')}</dt>
                  <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{formatDate(course.start_time)}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('courseDetails.overview.endDate')}</dt>
                  <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{formatDate(course.end_time)}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('courses.price')}</dt>
                  <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">${course.price}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('courseDetails.overview.maximumStudents')}</dt>
                  <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{course.max_students}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('courseDetails.overview.format')}</dt>
                ...
                {!course.is_online && (
                  <div>
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('courseDetails.overview.location')}</dt>
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">{course.location}</dd>
                  </div>
                )}
              </dl>
            </CardContent>
